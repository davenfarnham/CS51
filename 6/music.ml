...
let treble = list_to_stream [Note((C,4),0.125,60);Note((F,4),0.125,60);Note((F,4),0.125,60);Note((G,4),0.125,60);Note((G,4),0.125,60);
			     ...
			     Note((C,5),0.0625,60);Note((A,4),0.0625,60);Note((G,4),0.125,60);
			     Note((C,5),0.0625,60);Note((A,4),0.0625,60);Note((G,4),0.125,60);
			     Note((C,5),0.0625,60);Note((A,4),0.0625,60);Note((G,4),0.1875,60);
			     Note((F,4),0.0625,60);Note((E,4),0.125,60);Note((C,5),0.0625,60);Note((A,4),0.0625,60);Note((G,4),0.125,60);
			     Note((C,5),0.0625,60);Note((A,4),0.0625,60);Note((G,4),0.125,60);Note((C,5),0.0625,60);Note((A,4),0.0625,60);

			     Note((G,4),0.1875,60);Note((F,4),0.0625,60);Note((E,4),0.125,60);Note((C,4),0.125,60);
			     Note((F,4),0.125,60);Note((F,4),0.125,60);Note((G,4),0.125,60);Note((G,4),0.125,60);
                             Note((A,4),0.1875,60);Note((Bb,4),0.0625,60);Note((C,5),0.125,60);Note((C,5),0.0625,60);Note((A,4),0.0625,60);
                             Note((G,4),0.125,60);Note((Bb,4),0.0625,60);Note((G,4),0.0625,60);Note((F,4),0.125,60);Note((E,4),0.125,60);
                             Note((F,4),0.375,60)];;
...
let bass = list_to_stream [Rest(0.125);Rest(0.125);Note((F,2),0.125,60);Note((E,2),0.125,60);Note((E,2),0.125,60);
			   ...
			   Note((F,2),0.125,60);Note((E,2),0.125,60);Note((F,2),0.125,60);Note((E,2),0.125,60);Note((F,2),0.125,60);
			   Note((E,2),0.1875,60);Note((D,2),0.0625,60);Note((C,2),0.125,60);Note((F,2),0.125,60);
			   Note((E,2),0.125,60);Note((F,2),0.125,60);Note((E,2),0.125,60);Note((F,2),0.125,60);

			   Note((E,2),0.1875,60);Note((D,2),0.0625,60);Note((C,2),0.25,60);
			   Note((F,2),0.125,60);Note((F,2),0.125,60);Note((E,2),0.125,60);Note((E,2),0.125,60);
			   Note((F,2),0.1875,60);Note((G,2),0.0625,60);Note((A,2),0.125,60);Note((A,2),0.125,60);
			   Note((Bb,2),0.125,60);Note((Bb,2),0.125,60);Note((C,3),0.125,60);Note((C,2),0.125,60);
			   Note((F,2),0.125,60);Note((C,2),0.125,60);Note((F,1),0.125,60)];;
